...
# git clone https://${HF_USERNAME}:${HF_ACCESS_TOKEN}@huggingface.co/meta-llama/Llama-3.2-3B-Instruct
git clone https://${HF_USERNAME}:${HF_ACCESS_TOKEN}@huggingface.co/meta-llama/Llama-3.2-3B
